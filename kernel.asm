...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 d7 5b 10 80 	movl   $0x80105bd7,0x14(%eax)
  p->context = (struct context*)sp;
...
80103ac9:	74 19                	je     80103ae4 <growproc+0x54>
    if(curproc != p && p->pgdir == curproc->pgdir) p->sz = sz;
...
80103ae8:	e8 83 32 00 00       	call   80106d70 <switchuvm>
  return 0;
...
80103b03:	e8 e8 34 00 00       	call   80106ff0 <allocuvm>
...
80103b2a:	e8 f1 35 00 00       	call   80107120 <deallocuvm>
...
80103b46:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b49:	e8 c2 0b 00 00       	call   80104710 <pushcli>
  c = mycpu();
80103b4e:	e8 9d fd ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103b53:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b59:	e8 02 0c 00 00       	call   80104760 <popcli>
  if((np = allocproc()) == 0){
...
80103b78:	e8 43 37 00 00       	call   801072c0 <copyuvm>
...
80103c66:	83 ec 2c             	sub    $0x2c,%esp
  pushcli();
80103c69:	e8 a2 0a 00 00       	call   80104710 <pushcli>
  c = mycpu();
80103c6e:	e8 7d fc ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103c73:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103c79:	e8 e2 0a 00 00       	call   80104760 <popcli>
  if((np = allocproc()) == 0) return -1;
80103c7e:	e8 2d fb ff ff       	call   801037b0 <allocproc>
80103c83:	85 c0                	test   %eax,%eax
80103c85:	0f 84 02 01 00 00    	je     80103d8d <clone+0x12d>
  if(((uint)stack % PGSIZE) != 0) return -1;
80103c8b:	f7 45 14 ff 0f 00 00 	testl  $0xfff,0x14(%ebp)
80103c92:	0f 85 f5 00 00 00    	jne    80103d8d <clone+0x12d>
80103c98:	89 c2                	mov    %eax,%edx
  if((curproc->sz - (uint)stack) < PGSIZE) return -1;
80103c9a:	8b 03                	mov    (%ebx),%eax
80103c9c:	2b 45 14             	sub    0x14(%ebp),%eax
80103c9f:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80103ca4:	0f 86 e3 00 00 00    	jbe    80103d8d <clone+0x12d>
  np->pgdir = curproc->pgdir;
80103caa:	8b 43 04             	mov    0x4(%ebx),%eax
  temp_stack[0] = 0xffffffff;
80103cad:	c7 45 dc ff ff ff ff 	movl   $0xffffffff,-0x24(%ebp)
  if(copyout(np->pgdir, (uint)((uint)stack + PGSIZE -12), temp_stack, 12) < 0) return -1;
80103cb4:	89 55 d0             	mov    %edx,-0x30(%ebp)
  np->pgdir = curproc->pgdir;
80103cb7:	89 42 04             	mov    %eax,0x4(%edx)
  temp_stack[1] = (uint) arg1;
80103cba:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(copyout(np->pgdir, (uint)((uint)stack + PGSIZE -12), temp_stack, 12) < 0) return -1;
80103cbd:	6a 0c                	push   $0xc
  temp_stack[1] = (uint) arg1;
80103cbf:	89 45 e0             	mov    %eax,-0x20(%ebp)
  temp_stack[2] = (uint) arg2;
80103cc2:	8b 45 10             	mov    0x10(%ebp),%eax
80103cc5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(copyout(np->pgdir, (uint)((uint)stack + PGSIZE -12), temp_stack, 12) < 0) return -1;
80103cc8:	8b 45 14             	mov    0x14(%ebp),%eax
80103ccb:	05 f4 0f 00 00       	add    $0xff4,%eax
80103cd0:	89 c1                	mov    %eax,%ecx
80103cd2:	8d 45 dc             	lea    -0x24(%ebp),%eax
80103cd5:	50                   	push   %eax
80103cd6:	51                   	push   %ecx
80103cd7:	ff 72 04             	push   0x4(%edx)
80103cda:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
80103cdd:	e8 5e 37 00 00       	call   80107440 <copyout>
80103ce2:	83 c4 10             	add    $0x10,%esp
80103ce5:	85 c0                	test   %eax,%eax
80103ce7:	0f 88 a0 00 00 00    	js     80103d8d <clone+0x12d>
  np->sz = curproc->sz;
80103ced:	8b 03                	mov    (%ebx),%eax
80103cef:	8b 55 d0             	mov    -0x30(%ebp),%edx
  *np->tf = *curproc->tf;
80103cf2:	b9 13 00 00 00       	mov    $0x13,%ecx
  np->sz = curproc->sz;
80103cf7:	89 02                	mov    %eax,(%edx)
  *np->tf = *curproc->tf;
80103cf9:	8b 7a 18             	mov    0x18(%edx),%edi
  np->parent = curproc;
80103cfc:	89 5a 14             	mov    %ebx,0x14(%edx)
  *np->tf = *curproc->tf;
80103cff:	8b 73 18             	mov    0x18(%ebx),%esi
80103d02:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  np->tf->eip = (uint)fcn;
80103d04:	8b 4d 08             	mov    0x8(%ebp),%ecx
  for(i = 0; i < NOFILE; i++)
80103d07:	31 f6                	xor    %esi,%esi
80103d09:	89 d7                	mov    %edx,%edi
  np->tf->eax = 0;
80103d0b:	8b 42 18             	mov    0x18(%edx),%eax
80103d0e:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  np->tf->eip = (uint)fcn;
80103d15:	8b 42 18             	mov    0x18(%edx),%eax
80103d18:	89 48 38             	mov    %ecx,0x38(%eax)
  np->tf->esp = (uint)((uint)stack + PGSIZE -12);
80103d1b:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
80103d1e:	8b 42 18             	mov    0x18(%edx),%eax
80103d21:	89 48 44             	mov    %ecx,0x44(%eax)
  np->stack = stack;
80103d24:	8b 45 14             	mov    0x14(%ebp),%eax
80103d27:	89 42 7c             	mov    %eax,0x7c(%edx)
  for(i = 0; i < NOFILE; i++)
80103d2a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(curproc->ofile[i])
80103d30:	8b 44 b3 28          	mov    0x28(%ebx,%esi,4),%eax
80103d34:	85 c0                	test   %eax,%eax
80103d36:	74 10                	je     80103d48 <clone+0xe8>
      np->ofile[i] = filedup(curproc->ofile[i]);
80103d38:	83 ec 0c             	sub    $0xc,%esp
80103d3b:	50                   	push   %eax
80103d3c:	e8 5f d1 ff ff       	call   80100ea0 <filedup>
...
80103d4e:	75 e0                	jne    80103d30 <clone+0xd0>
  np->cwd = idup(curproc->cwd);
80103d50:	83 ec 0c             	sub    $0xc,%esp
80103d53:	ff 73 68             	push   0x68(%ebx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103d56:	83 c3 6c             	add    $0x6c,%ebx
  np->cwd = idup(curproc->cwd);
80103d59:	89 7d d4             	mov    %edi,-0x2c(%ebp)
80103d5c:	e8 ef d9 ff ff       	call   80101750 <idup>
80103d61:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103d64:	83 c4 0c             	add    $0xc,%esp
  np->cwd = idup(curproc->cwd);
80103d67:	89 42 68             	mov    %eax,0x68(%edx)
  pid = np->pid;
80103d6a:	8b 72 10             	mov    0x10(%edx),%esi
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103d6d:	83 c2 6c             	add    $0x6c,%edx
  np->state = RUNNABLE;
80103d70:	c7 42 a0 03 00 00 00 	movl   $0x3,-0x60(%edx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103d77:	6a 10                	push   $0x10
80103d79:	53                   	push   %ebx
80103d7a:	52                   	push   %edx
80103d7b:	e8 60 0d 00 00       	call   80104ae0 <safestrcpy>
  return pid;
...
80103d92:	eb ef                	jmp    80103d83 <clone+0x123>
...
80103df0:	e8 7b 2f 00 00       	call   80106d70 <switchuvm>
...
80103e02:	e8 34 0d 00 00       	call   80104b3b <swtch>
      switchkvm();
80103e07:	e8 54 2f 00 00       	call   80106d60 <switchkvm>
      c->proc = 0;
...
80104241:	e8 0a 2f 00 00       	call   80107150 <freevm>
        p->pid = 0;
...
{
  return fork();
80105950:	e9 eb e1 ff ff       	jmp    80103b40 <fork>
...
80105b6b:	e8 f0 e0 ff ff       	call   80103c60 <clone>
...
80105b8c:	6a 00                	push   $0x0
  void **stack = NULL;
80105b8e:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  if(argptr(0, (void*)&stack, sizeof(void**)) < 0) return -1;
80105b95:	e8 96 f0 ff ff       	call   80104c30 <argptr>
80105b9a:	83 c4 10             	add    $0x10,%esp
80105b9d:	85 c0                	test   %eax,%eax
80105b9f:	78 17                	js     80105bb8 <sys_join+0x38>
  
  return join(stack);
80105ba1:	83 ec 0c             	sub    $0xc,%esp
80105ba4:	ff 75 f4             	push   -0xc(%ebp)
80105ba7:	e8 84 e4 ff ff       	call   80104030 <join>
...
80105bc0:	06                   	push   %es
  pushl %fs
80105bc1:	0f a0                	push   %fs
  pushl %gs
80105bc3:	0f a8                	push   %gs
  pushal
80105bc5:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105bc6:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105bca:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105bcc:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105bce:	54                   	push   %esp
  call trap
80105bcf:	e8 cc 00 00 00       	call   80105ca0 <trap>
  addl $4, %esp
80105bd4:	83 c4 04             	add    $0x4,%esp
...
80105bd7:	61                   	popa   
  popl %gs
80105bd8:	0f a9                	pop    %gs
  popl %fs
80105bda:	0f a1                	pop    %fs
  popl %es
80105bdc:	07                   	pop    %es
  popl %ds
80105bdd:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105bde:	83 c4 08             	add    $0x8,%esp
  iret
80105be1:	cf                   	iret   
80105be2:	66 90                	xchg   %ax,%ax
80105be4:	66 90                	xchg   %ax,%ax
...
80105c07:	c7 04 c5 c2 3d 11 80 	movl   $0x8e000008,-0x7feec23e(,%eax,8)
80105c0e:	08 00 00 8e 
80105c12:	66 89 14 c5 c0 3d 11 	mov    %dx,-0x7feec240(,%eax,8)
80105c19:	80 
80105c1a:	c1 ea 10             	shr    $0x10,%edx
80105c1d:	66 89 14 c5 c6 3d 11 	mov    %dx,-0x7feec23a(,%eax,8)
80105c24:	80 
  for(i = 0; i < 256; i++)
...
80105c37:	c7 05 c2 3f 11 80 08 	movl   $0xef000008,0x80113fc2
80105c3e:	00 00 ef 
  initlock(&tickslock, "time");
80105c41:	68 a1 7c 10 80       	push   $0x80107ca1
80105c46:	68 80 3d 11 80       	push   $0x80113d80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105c4b:	66 a3 c0 3f 11 80    	mov    %ax,0x80113fc0
80105c51:	c1 e8 10             	shr    $0x10,%eax
80105c54:	66 a3 c6 3f 11 80    	mov    %ax,0x80113fc6
  initlock(&tickslock, "time");
80105c5a:	e8 31 ea ff ff       	call   80104690 <initlock>
}
...
80105c7b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105c7f:	b8 c0 3d 11 80       	mov    $0x80113dc0,%eax
...
80105cc4:	ff 24 85 48 7d 10 80 	jmp    *-0x7fef82b8(,%eax,4)
...
80105da5:	68 04 7d 10 80       	push   $0x80107d04
...
80105dd4:	0f 85 3e ff ff ff    	jne    80105d18 <trap+0x78>
    yield();
80105dda:	e8 d1 e4 ff ff       	call   801042b0 <yield>
...
80105df7:	68 ac 7c 10 80       	push   $0x80107cac
...
80105e35:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105e38:	e8 e3 ee ff ff       	call   80104d20 <syscall>
    if(myproc()->killed)
...
80105e53:	5d                   	pop    %ebp
      exit();
80105e54:	e9 a7 e0 ff ff       	jmp    80103f00 <exit>
...
80105eb0:	68 80 3d 11 80       	push   $0x80113d80
80105eb5:	e8 a6 e9 ff ff       	call   80104860 <acquire>
      wakeup(&ticks);
80105eba:	c7 04 24 60 3d 11 80 	movl   $0x80113d60,(%esp)
      ticks++;
80105ec1:	83 05 60 3d 11 80 01 	addl   $0x1,0x80113d60
      wakeup(&ticks);
80105ec8:	e8 f3 e4 ff ff       	call   801043c0 <wakeup>
      release(&tickslock);
80105ecd:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
80105ed4:	e8 27 e9 ff ff       	call   80104800 <release>
...
80105ef2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105ef8:	e8 03 e0 ff ff       	call   80103f00 <exit>
...
80105f13:	68 d0 7c 10 80       	push   $0x80107cd0
80105f18:	e8 83 a7 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105f1d:	83 c4 14             	add    $0x14,%esp
80105f20:	68 a6 7c 10 80       	push   $0x80107ca6
...
{
  if(!uart)
80105f30:	a1 c0 45 11 80       	mov    0x801145c0,%eax
...
80105fb7:	74 78                	je     80106031 <uartinit+0xd1>
  uart = 1;
80105fb9:	c7 05 c0 45 11 80 01 	movl   $0x1,0x801145c0
80105fc0:	00 00 00 
...
80105fcc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105fcf:	bf c8 7d 10 80       	mov    $0x80107dc8,%edi
...
80106040 <uartputc>:
  if(!uart)
80106040:	a1 c0 45 11 80       	mov    0x801145c0,%eax
...
801060b7:	6a 00                	push   $0x0
  jmp alltraps
801060b9:	e9 01 fb ff ff       	jmp    80105bbf <alltraps>
...
801060c0:	6a 01                	push   $0x1
  jmp alltraps
801060c2:	e9 f8 fa ff ff       	jmp    80105bbf <alltraps>
...
801060c9:	6a 02                	push   $0x2
  jmp alltraps
801060cb:	e9 ef fa ff ff       	jmp    80105bbf <alltraps>
...
801060d2:	6a 03                	push   $0x3
  jmp alltraps
801060d4:	e9 e6 fa ff ff       	jmp    80105bbf <alltraps>
...
801060db:	6a 04                	push   $0x4
  jmp alltraps
801060dd:	e9 dd fa ff ff       	jmp    80105bbf <alltraps>
...
801060e4:	6a 05                	push   $0x5
  jmp alltraps
801060e6:	e9 d4 fa ff ff       	jmp    80105bbf <alltraps>
...
801060ed:	6a 06                	push   $0x6
  jmp alltraps
801060ef:	e9 cb fa ff ff       	jmp    80105bbf <alltraps>
...
801060f6:	6a 07                	push   $0x7
  jmp alltraps
801060f8:	e9 c2 fa ff ff       	jmp    80105bbf <alltraps>
...
801060fd:	6a 08                	push   $0x8
  jmp alltraps
801060ff:	e9 bb fa ff ff       	jmp    80105bbf <alltraps>
...
80106106:	6a 09                	push   $0x9
  jmp alltraps
80106108:	e9 b2 fa ff ff       	jmp    80105bbf <alltraps>
...
8010610d:	6a 0a                	push   $0xa
  jmp alltraps
8010610f:	e9 ab fa ff ff       	jmp    80105bbf <alltraps>
...
80106114:	6a 0b                	push   $0xb
  jmp alltraps
80106116:	e9 a4 fa ff ff       	jmp    80105bbf <alltraps>
...
8010611b:	6a 0c                	push   $0xc
  jmp alltraps
8010611d:	e9 9d fa ff ff       	jmp    80105bbf <alltraps>
...
80106122:	6a 0d                	push   $0xd
  jmp alltraps
80106124:	e9 96 fa ff ff       	jmp    80105bbf <alltraps>
...
80106129:	6a 0e                	push   $0xe
  jmp alltraps
8010612b:	e9 8f fa ff ff       	jmp    80105bbf <alltraps>
...
80106132:	6a 0f                	push   $0xf
  jmp alltraps
80106134:	e9 86 fa ff ff       	jmp    80105bbf <alltraps>
...
8010613b:	6a 10                	push   $0x10
  jmp alltraps
8010613d:	e9 7d fa ff ff       	jmp    80105bbf <alltraps>
...
80106142:	6a 11                	push   $0x11
  jmp alltraps
80106144:	e9 76 fa ff ff       	jmp    80105bbf <alltraps>
...
8010614b:	6a 12                	push   $0x12
  jmp alltraps
8010614d:	e9 6d fa ff ff       	jmp    80105bbf <alltraps>
...
80106154:	6a 13                	push   $0x13
  jmp alltraps
80106156:	e9 64 fa ff ff       	jmp    80105bbf <alltraps>
...
8010615d:	6a 14                	push   $0x14
  jmp alltraps
8010615f:	e9 5b fa ff ff       	jmp    80105bbf <alltraps>
...
80106166:	6a 15                	push   $0x15
  jmp alltraps
80106168:	e9 52 fa ff ff       	jmp    80105bbf <alltraps>
...
8010616f:	6a 16                	push   $0x16
  jmp alltraps
80106171:	e9 49 fa ff ff       	jmp    80105bbf <alltraps>
...
80106178:	6a 17                	push   $0x17
  jmp alltraps
8010617a:	e9 40 fa ff ff       	jmp    80105bbf <alltraps>
...
80106181:	6a 18                	push   $0x18
  jmp alltraps
80106183:	e9 37 fa ff ff       	jmp    80105bbf <alltraps>
...
8010618a:	6a 19                	push   $0x19
  jmp alltraps
8010618c:	e9 2e fa ff ff       	jmp    80105bbf <alltraps>
...
80106193:	6a 1a                	push   $0x1a
  jmp alltraps
80106195:	e9 25 fa ff ff       	jmp    80105bbf <alltraps>
...
8010619c:	6a 1b                	push   $0x1b
  jmp alltraps
8010619e:	e9 1c fa ff ff       	jmp    80105bbf <alltraps>
...
801061a5:	6a 1c                	push   $0x1c
  jmp alltraps
801061a7:	e9 13 fa ff ff       	jmp    80105bbf <alltraps>
...
801061ae:	6a 1d                	push   $0x1d
  jmp alltraps
801061b0:	e9 0a fa ff ff       	jmp    80105bbf <alltraps>
...
801061b7:	6a 1e                	push   $0x1e
  jmp alltraps
801061b9:	e9 01 fa ff ff       	jmp    80105bbf <alltraps>
...
801061c0:	6a 1f                	push   $0x1f
  jmp alltraps
801061c2:	e9 f8 f9 ff ff       	jmp    80105bbf <alltraps>
...
801061c9:	6a 20                	push   $0x20
  jmp alltraps
801061cb:	e9 ef f9 ff ff       	jmp    80105bbf <alltraps>
...
801061d2:	6a 21                	push   $0x21
  jmp alltraps
801061d4:	e9 e6 f9 ff ff       	jmp    80105bbf <alltraps>
...
801061db:	6a 22                	push   $0x22
  jmp alltraps
801061dd:	e9 dd f9 ff ff       	jmp    80105bbf <alltraps>
...
801061e4:	6a 23                	push   $0x23
  jmp alltraps
801061e6:	e9 d4 f9 ff ff       	jmp    80105bbf <alltraps>
...
801061ed:	6a 24                	push   $0x24
  jmp alltraps
801061ef:	e9 cb f9 ff ff       	jmp    80105bbf <alltraps>
...
801061f6:	6a 25                	push   $0x25
  jmp alltraps
801061f8:	e9 c2 f9 ff ff       	jmp    80105bbf <alltraps>
...
801061ff:	6a 26                	push   $0x26
  jmp alltraps
80106201:	e9 b9 f9 ff ff       	jmp    80105bbf <alltraps>
...
80106208:	6a 27                	push   $0x27
  jmp alltraps
8010620a:	e9 b0 f9 ff ff       	jmp    80105bbf <alltraps>
...
80106211:	6a 28                	push   $0x28
  jmp alltraps
80106213:	e9 a7 f9 ff ff       	jmp    80105bbf <alltraps>
...
8010621a:	6a 29                	push   $0x29
  jmp alltraps
8010621c:	e9 9e f9 ff ff       	jmp    80105bbf <alltraps>
...
80106223:	6a 2a                	push   $0x2a
  jmp alltraps
80106225:	e9 95 f9 ff ff       	jmp    80105bbf <alltraps>
...
8010622c:	6a 2b                	push   $0x2b
  jmp alltraps
8010622e:	e9 8c f9 ff ff       	jmp    80105bbf <alltraps>
...
80106235:	6a 2c                	push   $0x2c
  jmp alltraps
80106237:	e9 83 f9 ff ff       	jmp    80105bbf <alltraps>
...
8010623e:	6a 2d                	push   $0x2d
  jmp alltraps
80106240:	e9 7a f9 ff ff       	jmp    80105bbf <alltraps>
...
80106247:	6a 2e                	push   $0x2e
  jmp alltraps
80106249:	e9 71 f9 ff ff       	jmp    80105bbf <alltraps>
...
80106250:	6a 2f                	push   $0x2f
  jmp alltraps
80106252:	e9 68 f9 ff ff       	jmp    80105bbf <alltraps>
...
80106259:	6a 30                	push   $0x30
  jmp alltraps
8010625b:	e9 5f f9 ff ff       	jmp    80105bbf <alltraps>
...
80106262:	6a 31                	push   $0x31
  jmp alltraps
80106264:	e9 56 f9 ff ff       	jmp    80105bbf <alltraps>
...
8010626b:	6a 32                	push   $0x32
  jmp alltraps
8010626d:	e9 4d f9 ff ff       	jmp    80105bbf <alltraps>
...
80106274:	6a 33                	push   $0x33
  jmp alltraps
80106276:	e9 44 f9 ff ff       	jmp    80105bbf <alltraps>
...
8010627d:	6a 34                	push   $0x34
  jmp alltraps
8010627f:	e9 3b f9 ff ff       	jmp    80105bbf <alltraps>
...
80106286:	6a 35                	push   $0x35
  jmp alltraps
80106288:	e9 32 f9 ff ff       	jmp    80105bbf <alltraps>
...
8010628f:	6a 36                	push   $0x36
  jmp alltraps
80106291:	e9 29 f9 ff ff       	jmp    80105bbf <alltraps>
...
80106298:	6a 37                	push   $0x37
  jmp alltraps
8010629a:	e9 20 f9 ff ff       	jmp    80105bbf <alltraps>
...
801062a1:	6a 38                	push   $0x38
  jmp alltraps
801062a3:	e9 17 f9 ff ff       	jmp    80105bbf <alltraps>
...
801062aa:	6a 39                	push   $0x39
  jmp alltraps
801062ac:	e9 0e f9 ff ff       	jmp    80105bbf <alltraps>
...
801062b3:	6a 3a                	push   $0x3a
  jmp alltraps
801062b5:	e9 05 f9 ff ff       	jmp    80105bbf <alltraps>
...
801062bc:	6a 3b                	push   $0x3b
  jmp alltraps
801062be:	e9 fc f8 ff ff       	jmp    80105bbf <alltraps>
...
801062c5:	6a 3c                	push   $0x3c
  jmp alltraps
801062c7:	e9 f3 f8 ff ff       	jmp    80105bbf <alltraps>
...
801062ce:	6a 3d                	push   $0x3d
  jmp alltraps
801062d0:	e9 ea f8 ff ff       	jmp    80105bbf <alltraps>
...
801062d7:	6a 3e                	push   $0x3e
  jmp alltraps
801062d9:	e9 e1 f8 ff ff       	jmp    80105bbf <alltraps>
...
801062e0:	6a 3f                	push   $0x3f
  jmp alltraps
801062e2:	e9 d8 f8 ff ff       	jmp    80105bbf <alltraps>
...
801062e9:	6a 40                	push   $0x40
  jmp alltraps
801062eb:	e9 cf f8 ff ff       	jmp    80105bbf <alltraps>
...
801062f2:	6a 41                	push   $0x41
  jmp alltraps
801062f4:	e9 c6 f8 ff ff       	jmp    80105bbf <alltraps>
...
801062fb:	6a 42                	push   $0x42
  jmp alltraps
801062fd:	e9 bd f8 ff ff       	jmp    80105bbf <alltraps>
...
80106304:	6a 43                	push   $0x43
  jmp alltraps
80106306:	e9 b4 f8 ff ff       	jmp    80105bbf <alltraps>
...
8010630d:	6a 44                	push   $0x44
  jmp alltraps
8010630f:	e9 ab f8 ff ff       	jmp    80105bbf <alltraps>
...
80106316:	6a 45                	push   $0x45
  jmp alltraps
80106318:	e9 a2 f8 ff ff       	jmp    80105bbf <alltraps>
...
8010631f:	6a 46                	push   $0x46
  jmp alltraps
80106321:	e9 99 f8 ff ff       	jmp    80105bbf <alltraps>
...
80106328:	6a 47                	push   $0x47
  jmp alltraps
8010632a:	e9 90 f8 ff ff       	jmp    80105bbf <alltraps>
...
80106331:	6a 48                	push   $0x48
  jmp alltraps
80106333:	e9 87 f8 ff ff       	jmp    80105bbf <alltraps>
...
8010633a:	6a 49                	push   $0x49
  jmp alltraps
8010633c:	e9 7e f8 ff ff       	jmp    80105bbf <alltraps>
...
80106343:	6a 4a                	push   $0x4a
  jmp alltraps
80106345:	e9 75 f8 ff ff       	jmp    80105bbf <alltraps>
...
8010634c:	6a 4b                	push   $0x4b
  jmp alltraps
8010634e:	e9 6c f8 ff ff       	jmp    80105bbf <alltraps>
...
80106355:	6a 4c                	push   $0x4c
  jmp alltraps
80106357:	e9 63 f8 ff ff       	jmp    80105bbf <alltraps>
...
8010635e:	6a 4d                	push   $0x4d
  jmp alltraps
80106360:	e9 5a f8 ff ff       	jmp    80105bbf <alltraps>
...
80106367:	6a 4e                	push   $0x4e
  jmp alltraps
80106369:	e9 51 f8 ff ff       	jmp    80105bbf <alltraps>
...
80106370:	6a 4f                	push   $0x4f
  jmp alltraps
80106372:	e9 48 f8 ff ff       	jmp    80105bbf <alltraps>
...
80106379:	6a 50                	push   $0x50
  jmp alltraps
8010637b:	e9 3f f8 ff ff       	jmp    80105bbf <alltraps>
...
80106382:	6a 51                	push   $0x51
  jmp alltraps
80106384:	e9 36 f8 ff ff       	jmp    80105bbf <alltraps>
...
8010638b:	6a 52                	push   $0x52
  jmp alltraps
8010638d:	e9 2d f8 ff ff       	jmp    80105bbf <alltraps>
...
80106394:	6a 53                	push   $0x53
  jmp alltraps
80106396:	e9 24 f8 ff ff       	jmp    80105bbf <alltraps>
...
8010639d:	6a 54                	push   $0x54
  jmp alltraps
8010639f:	e9 1b f8 ff ff       	jmp    80105bbf <alltraps>
...
801063a6:	6a 55                	push   $0x55
  jmp alltraps
801063a8:	e9 12 f8 ff ff       	jmp    80105bbf <alltraps>
...
801063af:	6a 56                	push   $0x56
  jmp alltraps
801063b1:	e9 09 f8 ff ff       	jmp    80105bbf <alltraps>
...
801063b8:	6a 57                	push   $0x57
  jmp alltraps
801063ba:	e9 00 f8 ff ff       	jmp    80105bbf <alltraps>
...
801063c1:	6a 58                	push   $0x58
  jmp alltraps
801063c3:	e9 f7 f7 ff ff       	jmp    80105bbf <alltraps>
...
801063ca:	6a 59                	push   $0x59
  jmp alltraps
801063cc:	e9 ee f7 ff ff       	jmp    80105bbf <alltraps>
...
801063d3:	6a 5a                	push   $0x5a
  jmp alltraps
801063d5:	e9 e5 f7 ff ff       	jmp    80105bbf <alltraps>
...
801063dc:	6a 5b                	push   $0x5b
  jmp alltraps
801063de:	e9 dc f7 ff ff       	jmp    80105bbf <alltraps>
...
801063e5:	6a 5c                	push   $0x5c
  jmp alltraps
801063e7:	e9 d3 f7 ff ff       	jmp    80105bbf <alltraps>
...
801063ee:	6a 5d                	push   $0x5d
  jmp alltraps
801063f0:	e9 ca f7 ff ff       	jmp    80105bbf <alltraps>
...
801063f7:	6a 5e                	push   $0x5e
  jmp alltraps
801063f9:	e9 c1 f7 ff ff       	jmp    80105bbf <alltraps>
...
80106400:	6a 5f                	push   $0x5f
  jmp alltraps
80106402:	e9 b8 f7 ff ff       	jmp    80105bbf <alltraps>
...
80106409:	6a 60                	push   $0x60
  jmp alltraps
8010640b:	e9 af f7 ff ff       	jmp    80105bbf <alltraps>
...
80106412:	6a 61                	push   $0x61
  jmp alltraps
80106414:	e9 a6 f7 ff ff       	jmp    80105bbf <alltraps>
...
8010641b:	6a 62                	push   $0x62
  jmp alltraps
8010641d:	e9 9d f7 ff ff       	jmp    80105bbf <alltraps>
...
80106424:	6a 63                	push   $0x63
  jmp alltraps
80106426:	e9 94 f7 ff ff       	jmp    80105bbf <alltraps>
...
8010642d:	6a 64                	push   $0x64
  jmp alltraps
8010642f:	e9 8b f7 ff ff       	jmp    80105bbf <alltraps>
...
80106436:	6a 65                	push   $0x65
  jmp alltraps
80106438:	e9 82 f7 ff ff       	jmp    80105bbf <alltraps>
...
8010643f:	6a 66                	push   $0x66
  jmp alltraps
80106441:	e9 79 f7 ff ff       	jmp    80105bbf <alltraps>
...
80106448:	6a 67                	push   $0x67
  jmp alltraps
8010644a:	e9 70 f7 ff ff       	jmp    80105bbf <alltraps>
...
80106451:	6a 68                	push   $0x68
  jmp alltraps
80106453:	e9 67 f7 ff ff       	jmp    80105bbf <alltraps>
...
8010645a:	6a 69                	push   $0x69
  jmp alltraps
8010645c:	e9 5e f7 ff ff       	jmp    80105bbf <alltraps>
...
80106463:	6a 6a                	push   $0x6a
  jmp alltraps
80106465:	e9 55 f7 ff ff       	jmp    80105bbf <alltraps>
...
8010646c:	6a 6b                	push   $0x6b
  jmp alltraps
8010646e:	e9 4c f7 ff ff       	jmp    80105bbf <alltraps>
...
80106475:	6a 6c                	push   $0x6c
  jmp alltraps
80106477:	e9 43 f7 ff ff       	jmp    80105bbf <alltraps>
...
8010647e:	6a 6d                	push   $0x6d
  jmp alltraps
80106480:	e9 3a f7 ff ff       	jmp    80105bbf <alltraps>
...
80106487:	6a 6e                	push   $0x6e
  jmp alltraps
80106489:	e9 31 f7 ff ff       	jmp    80105bbf <alltraps>
...
80106490:	6a 6f                	push   $0x6f
  jmp alltraps
80106492:	e9 28 f7 ff ff       	jmp    80105bbf <alltraps>
...
80106499:	6a 70                	push   $0x70
  jmp alltraps
8010649b:	e9 1f f7 ff ff       	jmp    80105bbf <alltraps>
...
801064a2:	6a 71                	push   $0x71
  jmp alltraps
801064a4:	e9 16 f7 ff ff       	jmp    80105bbf <alltraps>
...
801064ab:	6a 72                	push   $0x72
  jmp alltraps
801064ad:	e9 0d f7 ff ff       	jmp    80105bbf <alltraps>
...
801064b4:	6a 73                	push   $0x73
  jmp alltraps
801064b6:	e9 04 f7 ff ff       	jmp    80105bbf <alltraps>
...
801064bd:	6a 74                	push   $0x74
  jmp alltraps
801064bf:	e9 fb f6 ff ff       	jmp    80105bbf <alltraps>
...
801064c6:	6a 75                	push   $0x75
  jmp alltraps
801064c8:	e9 f2 f6 ff ff       	jmp    80105bbf <alltraps>
...
801064cf:	6a 76                	push   $0x76
  jmp alltraps
801064d1:	e9 e9 f6 ff ff       	jmp    80105bbf <alltraps>
...
801064d8:	6a 77                	push   $0x77
  jmp alltraps
801064da:	e9 e0 f6 ff ff       	jmp    80105bbf <alltraps>
...
801064e1:	6a 78                	push   $0x78
  jmp alltraps
801064e3:	e9 d7 f6 ff ff       	jmp    80105bbf <alltraps>
...
801064ea:	6a 79                	push   $0x79
  jmp alltraps
801064ec:	e9 ce f6 ff ff       	jmp    80105bbf <alltraps>
...
801064f3:	6a 7a                	push   $0x7a
  jmp alltraps
801064f5:	e9 c5 f6 ff ff       	jmp    80105bbf <alltraps>
...
801064fc:	6a 7b                	push   $0x7b
  jmp alltraps
801064fe:	e9 bc f6 ff ff       	jmp    80105bbf <alltraps>
...
80106505:	6a 7c                	push   $0x7c
  jmp alltraps
80106507:	e9 b3 f6 ff ff       	jmp    80105bbf <alltraps>
...
8010650e:	6a 7d                	push   $0x7d
  jmp alltraps
80106510:	e9 aa f6 ff ff       	jmp    80105bbf <alltraps>
...
80106517:	6a 7e                	push   $0x7e
  jmp alltraps
80106519:	e9 a1 f6 ff ff       	jmp    80105bbf <alltraps>
...
80106520:	6a 7f                	push   $0x7f
  jmp alltraps
80106522:	e9 98 f6 ff ff       	jmp    80105bbf <alltraps>
...
80106529:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010652e:	e9 8c f6 ff ff       	jmp    80105bbf <alltraps>
...
80106535:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010653a:	e9 80 f6 ff ff       	jmp    80105bbf <alltraps>
...
80106541:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106546:	e9 74 f6 ff ff       	jmp    80105bbf <alltraps>
...
8010654d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106552:	e9 68 f6 ff ff       	jmp    80105bbf <alltraps>
...
80106559:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010655e:	e9 5c f6 ff ff       	jmp    80105bbf <alltraps>
...
80106565:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010656a:	e9 50 f6 ff ff       	jmp    80105bbf <alltraps>
...
80106571:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106576:	e9 44 f6 ff ff       	jmp    80105bbf <alltraps>
...
8010657d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106582:	e9 38 f6 ff ff       	jmp    80105bbf <alltraps>
...
80106589:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010658e:	e9 2c f6 ff ff       	jmp    80105bbf <alltraps>
...
80106595:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010659a:	e9 20 f6 ff ff       	jmp    80105bbf <alltraps>
...
801065a1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801065a6:	e9 14 f6 ff ff       	jmp    80105bbf <alltraps>
...
801065ad:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801065b2:	e9 08 f6 ff ff       	jmp    80105bbf <alltraps>
...
801065b9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801065be:	e9 fc f5 ff ff       	jmp    80105bbf <alltraps>
...
801065c5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801065ca:	e9 f0 f5 ff ff       	jmp    80105bbf <alltraps>
...
801065d1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801065d6:	e9 e4 f5 ff ff       	jmp    80105bbf <alltraps>
...
801065dd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801065e2:	e9 d8 f5 ff ff       	jmp    80105bbf <alltraps>
...
801065e9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801065ee:	e9 cc f5 ff ff       	jmp    80105bbf <alltraps>
...
801065f5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801065fa:	e9 c0 f5 ff ff       	jmp    80105bbf <alltraps>
...
80106601:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106606:	e9 b4 f5 ff ff       	jmp    80105bbf <alltraps>
...
8010660d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106612:	e9 a8 f5 ff ff       	jmp    80105bbf <alltraps>
...
80106619:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010661e:	e9 9c f5 ff ff       	jmp    80105bbf <alltraps>
...
80106625:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010662a:	e9 90 f5 ff ff       	jmp    80105bbf <alltraps>
...
80106631:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106636:	e9 84 f5 ff ff       	jmp    80105bbf <alltraps>
...
8010663d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106642:	e9 78 f5 ff ff       	jmp    80105bbf <alltraps>
...
80106649:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010664e:	e9 6c f5 ff ff       	jmp    80105bbf <alltraps>
...
80106655:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010665a:	e9 60 f5 ff ff       	jmp    80105bbf <alltraps>
...
80106661:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106666:	e9 54 f5 ff ff       	jmp    80105bbf <alltraps>
...
8010666d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106672:	e9 48 f5 ff ff       	jmp    80105bbf <alltraps>
...
80106679:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010667e:	e9 3c f5 ff ff       	jmp    80105bbf <alltraps>
...
80106685:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010668a:	e9 30 f5 ff ff       	jmp    80105bbf <alltraps>
...
80106691:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106696:	e9 24 f5 ff ff       	jmp    80105bbf <alltraps>
...
8010669d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801066a2:	e9 18 f5 ff ff       	jmp    80105bbf <alltraps>
...
801066a9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801066ae:	e9 0c f5 ff ff       	jmp    80105bbf <alltraps>
...
801066b5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801066ba:	e9 00 f5 ff ff       	jmp    80105bbf <alltraps>
...
801066c1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801066c6:	e9 f4 f4 ff ff       	jmp    80105bbf <alltraps>
...
801066cd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801066d2:	e9 e8 f4 ff ff       	jmp    80105bbf <alltraps>
...
801066d9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801066de:	e9 dc f4 ff ff       	jmp    80105bbf <alltraps>
...
801066e5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801066ea:	e9 d0 f4 ff ff       	jmp    80105bbf <alltraps>
...
801066f1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801066f6:	e9 c4 f4 ff ff       	jmp    80105bbf <alltraps>
...
801066fd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106702:	e9 b8 f4 ff ff       	jmp    80105bbf <alltraps>
...
80106709:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010670e:	e9 ac f4 ff ff       	jmp    80105bbf <alltraps>
...
80106715:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010671a:	e9 a0 f4 ff ff       	jmp    80105bbf <alltraps>
...
80106721:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106726:	e9 94 f4 ff ff       	jmp    80105bbf <alltraps>
...
8010672d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106732:	e9 88 f4 ff ff       	jmp    80105bbf <alltraps>
...
80106739:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010673e:	e9 7c f4 ff ff       	jmp    80105bbf <alltraps>
...
80106745:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010674a:	e9 70 f4 ff ff       	jmp    80105bbf <alltraps>
...
80106751:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106756:	e9 64 f4 ff ff       	jmp    80105bbf <alltraps>
...
8010675d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106762:	e9 58 f4 ff ff       	jmp    80105bbf <alltraps>
...
80106769:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010676e:	e9 4c f4 ff ff       	jmp    80105bbf <alltraps>
...
80106775:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010677a:	e9 40 f4 ff ff       	jmp    80105bbf <alltraps>
...
80106781:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106786:	e9 34 f4 ff ff       	jmp    80105bbf <alltraps>
...
8010678d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106792:	e9 28 f4 ff ff       	jmp    80105bbf <alltraps>
...
80106799:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010679e:	e9 1c f4 ff ff       	jmp    80105bbf <alltraps>
...
801067a5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801067aa:	e9 10 f4 ff ff       	jmp    80105bbf <alltraps>
...
801067b1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801067b6:	e9 04 f4 ff ff       	jmp    80105bbf <alltraps>
...
801067bd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801067c2:	e9 f8 f3 ff ff       	jmp    80105bbf <alltraps>
...
801067c9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801067ce:	e9 ec f3 ff ff       	jmp    80105bbf <alltraps>
...
801067d5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801067da:	e9 e0 f3 ff ff       	jmp    80105bbf <alltraps>
...
801067e1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801067e6:	e9 d4 f3 ff ff       	jmp    80105bbf <alltraps>
...
801067ed:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801067f2:	e9 c8 f3 ff ff       	jmp    80105bbf <alltraps>
...
801067f9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801067fe:	e9 bc f3 ff ff       	jmp    80105bbf <alltraps>
...
80106805:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010680a:	e9 b0 f3 ff ff       	jmp    80105bbf <alltraps>
...
80106811:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106816:	e9 a4 f3 ff ff       	jmp    80105bbf <alltraps>
...
8010681d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106822:	e9 98 f3 ff ff       	jmp    80105bbf <alltraps>
...
80106829:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010682e:	e9 8c f3 ff ff       	jmp    80105bbf <alltraps>
...
80106835:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010683a:	e9 80 f3 ff ff       	jmp    80105bbf <alltraps>
...
80106841:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106846:	e9 74 f3 ff ff       	jmp    80105bbf <alltraps>
...
8010684d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106852:	e9 68 f3 ff ff       	jmp    80105bbf <alltraps>
...
80106859:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010685e:	e9 5c f3 ff ff       	jmp    80105bbf <alltraps>
...
80106865:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010686a:	e9 50 f3 ff ff       	jmp    80105bbf <alltraps>
...
80106871:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106876:	e9 44 f3 ff ff       	jmp    80105bbf <alltraps>
...
8010687d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106882:	e9 38 f3 ff ff       	jmp    80105bbf <alltraps>
...
80106889:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010688e:	e9 2c f3 ff ff       	jmp    80105bbf <alltraps>
...
80106895:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010689a:	e9 20 f3 ff ff       	jmp    80105bbf <alltraps>
...
801068a1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801068a6:	e9 14 f3 ff ff       	jmp    80105bbf <alltraps>
...
801068ad:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801068b2:	e9 08 f3 ff ff       	jmp    80105bbf <alltraps>
...
801068b9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801068be:	e9 fc f2 ff ff       	jmp    80105bbf <alltraps>
...
801068c5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801068ca:	e9 f0 f2 ff ff       	jmp    80105bbf <alltraps>
...
801068d1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801068d6:	e9 e4 f2 ff ff       	jmp    80105bbf <alltraps>
...
801068dd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801068e2:	e9 d8 f2 ff ff       	jmp    80105bbf <alltraps>
...
801068e9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801068ee:	e9 cc f2 ff ff       	jmp    80105bbf <alltraps>
...
801068f5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801068fa:	e9 c0 f2 ff ff       	jmp    80105bbf <alltraps>
...
80106901:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106906:	e9 b4 f2 ff ff       	jmp    80105bbf <alltraps>
...
8010690d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106912:	e9 a8 f2 ff ff       	jmp    80105bbf <alltraps>
...
80106919:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010691e:	e9 9c f2 ff ff       	jmp    80105bbf <alltraps>
...
80106925:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010692a:	e9 90 f2 ff ff       	jmp    80105bbf <alltraps>
...
80106931:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106936:	e9 84 f2 ff ff       	jmp    80105bbf <alltraps>
...
8010693d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106942:	e9 78 f2 ff ff       	jmp    80105bbf <alltraps>
...
80106949:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010694e:	e9 6c f2 ff ff       	jmp    80105bbf <alltraps>
...
80106955:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010695a:	e9 60 f2 ff ff       	jmp    80105bbf <alltraps>
...
80106961:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106966:	e9 54 f2 ff ff       	jmp    80105bbf <alltraps>
...
8010696d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106972:	e9 48 f2 ff ff       	jmp    80105bbf <alltraps>
...
80106979:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010697e:	e9 3c f2 ff ff       	jmp    80105bbf <alltraps>
...
80106985:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010698a:	e9 30 f2 ff ff       	jmp    80105bbf <alltraps>
...
80106991:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106996:	e9 24 f2 ff ff       	jmp    80105bbf <alltraps>
...
8010699d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801069a2:	e9 18 f2 ff ff       	jmp    80105bbf <alltraps>
...
801069a9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801069ae:	e9 0c f2 ff ff       	jmp    80105bbf <alltraps>
...
801069b5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801069ba:	e9 00 f2 ff ff       	jmp    80105bbf <alltraps>
...
801069c1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801069c6:	e9 f4 f1 ff ff       	jmp    80105bbf <alltraps>
...
801069cd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801069d2:	e9 e8 f1 ff ff       	jmp    80105bbf <alltraps>
...
801069d9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801069de:	e9 dc f1 ff ff       	jmp    80105bbf <alltraps>
...
801069e5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801069ea:	e9 d0 f1 ff ff       	jmp    80105bbf <alltraps>
...
801069f1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801069f6:	e9 c4 f1 ff ff       	jmp    80105bbf <alltraps>
...
801069fd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106a02:	e9 b8 f1 ff ff       	jmp    80105bbf <alltraps>
...
80106a09:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106a0e:	e9 ac f1 ff ff       	jmp    80105bbf <alltraps>
...
80106a15:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106a1a:	e9 a0 f1 ff ff       	jmp    80105bbf <alltraps>
...
80106a21:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106a26:	e9 94 f1 ff ff       	jmp    80105bbf <alltraps>
...
80106a2d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106a32:	e9 88 f1 ff ff       	jmp    80105bbf <alltraps>
...
80106a39:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106a3e:	e9 7c f1 ff ff       	jmp    80105bbf <alltraps>
...
80106a45:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106a4a:	e9 70 f1 ff ff       	jmp    80105bbf <alltraps>
...
80106a51:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106a56:	e9 64 f1 ff ff       	jmp    80105bbf <alltraps>
...
80106a5d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106a62:	e9 58 f1 ff ff       	jmp    80105bbf <alltraps>
...
80106a69:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106a6e:	e9 4c f1 ff ff       	jmp    80105bbf <alltraps>
...
80106a75:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106a7a:	e9 40 f1 ff ff       	jmp    80105bbf <alltraps>
...
80106a81:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106a86:	e9 34 f1 ff ff       	jmp    80105bbf <alltraps>
...
80106a8d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106a92:	e9 28 f1 ff ff       	jmp    80105bbf <alltraps>
...
80106a99:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106a9e:	e9 1c f1 ff ff       	jmp    80105bbf <alltraps>
...
80106aa5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106aaa:	e9 10 f1 ff ff       	jmp    80105bbf <alltraps>
...
80106ab1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106ab6:	e9 04 f1 ff ff       	jmp    80105bbf <alltraps>
...
80106abd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106ac2:	e9 f8 f0 ff ff       	jmp    80105bbf <alltraps>
...
80106ac9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106ace:	e9 ec f0 ff ff       	jmp    80105bbf <alltraps>
...
80106ad5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106ada:	e9 e0 f0 ff ff       	jmp    80105bbf <alltraps>
...
80106ae1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106ae6:	e9 d4 f0 ff ff       	jmp    80105bbf <alltraps>
...
80106aed:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106af2:	e9 c8 f0 ff ff       	jmp    80105bbf <alltraps>
...
80106af9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106afe:	e9 bc f0 ff ff       	jmp    80105bbf <alltraps>
...
80106b05:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106b0a:	e9 b0 f0 ff ff       	jmp    80105bbf <alltraps>
...
80106b11:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106b16:	e9 a4 f0 ff ff       	jmp    80105bbf <alltraps>
...
80106b1d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106b22:	e9 98 f0 ff ff       	jmp    80105bbf <alltraps>
...
80106c75:	e8 a6 dc ff ff       	call   80104920 <memset>
...
80106cbd:	68 d0 7d 10 80       	push   $0x80107dd0
...
80106d60:	a1 c4 45 11 80       	mov    0x801145c4,%eax
...
80106d94:	0f 84 c2 00 00 00    	je     80106e5c <switchuvm+0xec>
  pushcli();
80106d9a:	e8 71 d9 ff ff       	call   80104710 <pushcli>
...
80106eaf:	e8 6c da ff ff       	call   80104920 <memset>
...
80106ee2:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106ee3:	e9 d8 da ff ff       	jmp    801049c0 <memmove>
    panic("inituvm: more than a page");
80106ee8:	83 ec 0c             	sub    $0xc,%esp
80106eeb:	68 15 7e 10 80       	push   $0x80107e15
...
80106f50:	68 2f 7e 10 80       	push   $0x80107e2f
...
80106fd8:	68 d0 7e 10 80       	push   $0x80107ed0
...
8010703b:	e8 e0 d8 ff ff       	call   80104920 <memset>
...
80107079:	68 4d 7e 10 80       	push   $0x80107e4d
...
801070db:	68 65 7e 10 80       	push   $0x80107e65
...
801071bc:	68 81 7e 10 80       	push   $0x80107e81
...
801071f0:	e8 2b d7 ff ff       	call   80104920 <memset>
...
8010725b:	a3 c4 45 11 80       	mov    %eax,0x801145c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010728c:	68 92 7e 10 80       	push   $0x80107e92
...
80107302:	68 9c 7e 10 80       	push   $0x80107e9c
...
80107360:	e8 5b d6 ff ff       	call   801049c0 <memmove>
...
801073d7:	68 b6 7e 10 80       	push   $0x80107eb6
...
80107490:	e8 2b d5 ff ff       	call   801049c0 <memmove>
    len -= n;
    buf += n;
