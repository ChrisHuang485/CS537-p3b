...
thread_create(void (*start_routine)(void *, void *), void* arg1, void* arg2)
{
  ...
  e8:	8b 0c 95 a0 0d 00 00 	mov    0xda0(,%edx,4),%ecx
  ef:	85 c9                	test   %ecx,%ecx
  f1:	75 ed                	jne    e0 <thread_create+0x40>
      {
        userStackAddr[i] = freeStack;
  f3:	89 1c 95 a0 0d 00 00 	mov    %ebx,0xda0(,%edx,4)
        valueArray[i] = childPid;
  fa:	89 04 95 a0 0c 00 00 	mov    %eax,0xca0(,%edx,4)
  {
    free(freeStack);
  }
 ...
 145:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
 ...
 168:	39 34 9d a0 0c 00 00 	cmp    %esi,0xca0(,%ebx,4)
 16f:	75 ef                	jne    160 <thread_join+0x20>
        free(userStackAddr[i]);
 171:	83 ec 0c             	sub    $0xc,%esp
 174:	ff 34 9d a0 0d 00 00 	push   0xda0(,%ebx,4)
 17b:	e8 90 05 00 00       	call   710 <free>
        valueArray[i] = -1;
        userStackAddr[i] = NULL;
 180:	83 c4 10             	add    $0x10,%esp
        valueArray[i] = -1;
 183:	c7 04 9d a0 0c 00 00 	movl   $0xffffffff,0xca0(,%ebx,4)
 18a:	ff ff ff ff 
        userStackAddr[i] = NULL;
 18e:	c7 04 9d a0 0d 00 00 	movl   $0x0,0xda0(,%ebx,4)
 195:	00 00 00 00 
    for(int i=0; i < SIZE; i++) {
...
free(void *ap)
{
 ...
 711:	a1 a0 0e 00 00       	mov    0xea0,%eax
{
 ...
 751:	5b                   	pop    %ebx
  freep = p;
 752:	89 15 a0 0e 00 00    	mov    %edx,0xea0
}
 758:	5e                   	pop    %esi
 759:	5f                   	pop    %edi
 75a:	5d                   	pop    %ebp
 ...
 789:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 78c:	89 15 a0 0e 00 00    	mov    %edx,0xea0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ac:	8b 3d a0 0e 00 00    	mov    0xea0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7ef:	73 4f                	jae    840 <malloc+0xa0>
    ...
    if(p == freep)
 7f1:	8b 3d a0 0e 00 00    	mov    0xea0,%edi
 ...
 81a:	e8 f1 fe ff ff       	call   710 <free>
  return freep;
 81f:	8b 15 a0 0e 00 00    	mov    0xea0,%edx
 ...
 84c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 84f:	89 15 a0 0e 00 00    	mov    %edx,0xea0
}
 ...
 85f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 860:	c7 05 a0 0e 00 00 a4 	movl   $0xea4,0xea0
 867:	0e 00 00 
    base.s.size = 0;
 86a:	bf a4 0e 00 00       	mov    $0xea4,%edi
    base.s.ptr = freep = prevp = &base;
 86f:	c7 05 a4 0e 00 00 a4 	movl   $0xea4,0xea4
 876:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 879:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 87b:	c7 05 a8 0e 00 00 00 	movl   $0x0,0xea8
 882:	00 00 00 
    if(p->s.size >= nunits){
