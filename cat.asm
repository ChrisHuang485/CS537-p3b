...
xchg(volatile uint *addr, uint newval)
{
 ...
 137:	75 f7                	jne    130 <lock_acquire+0x10>
  ;
}
 139:	5d                   	pop    %ebp
 13a:	c3                   	ret    
...
thread_create(void (*start_routine)(void *, void *), void* arg1, void* arg2)
{
 ...
 153:	53                   	push   %ebx
 154:	83 ec 20             	sub    $0x20,%esp
  void * freeStack = malloc(2*PGSIZE);
 157:	68 00 20 00 00       	push   $0x2000
 15c:	e8 ef 06 00 00       	call   850 <malloc>
  if(freeStack == 0) return -1;
 161:	83 c4 10             	add    $0x10,%esp
 164:	85 c0                	test   %eax,%eax
 166:	74 7f                	je     1e7 <thread_create+0x97>

  void *stack = freeStack;
  if((uint)freeStack % PGSIZE != 0)
 168:	89 c2                	mov    %eax,%edx
 16a:	89 c3                	mov    %eax,%ebx
 16c:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 172:	75 4c                	jne    1c0 <thread_create+0x70>
 ...
 17e:	e8 d0 03 00 00       	call   553 <clone>
  if(childPid != -1)
 183:	83 c4 10             	add    $0x10,%esp
 186:	83 f8 ff             	cmp    $0xffffffff,%eax
 189:	74 45                	je     1d0 <thread_create+0x80>
  {
    for(int i = 0; i < SIZE; i++)
 18b:	31 d2                	xor    %edx,%edx
 18d:	eb 09                	jmp    198 <thread_create+0x48>
 18f:	90                   	nop
 190:	83 c2 01             	add    $0x1,%edx
 193:	83 fa 40             	cmp    $0x40,%edx
 196:	74 19                	je     1b1 <thread_create+0x61>
    {
      if(userStackAddr[i] == NULL)
 198:	8b 0c 95 80 10 00 00 	mov    0x1080(,%edx,4),%ecx
 19f:	85 c9                	test   %ecx,%ecx
 1a1:	75 ed                	jne    190 <thread_create+0x40>
      {
        userStackAddr[i] = freeStack;
 1a3:	89 1c 95 80 10 00 00 	mov    %ebx,0x1080(,%edx,4)
        valueArray[i] = childPid;
 1aa:	89 04 95 80 0f 00 00 	mov    %eax,0xf80(,%edx,4)
  {
    free(freeStack);
  }
 ...
 1bd:	8d 76 00             	lea    0x0(%esi),%esi
    stack = freeStack + PGSIZE -((uint)freeStack % PGSIZE);
 1c0:	29 d0                	sub    %edx,%eax
 1c2:	05 00 10 00 00       	add    $0x1000,%eax
 1c7:	eb ab                	jmp    174 <thread_create+0x24>
 1c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    free(freeStack);
 1d0:	83 ec 0c             	sub    $0xc,%esp
 1d3:	89 45 f4             	mov    %eax,-0xc(%ebp)
 1d6:	53                   	push   %ebx
 1d7:	e8 e4 05 00 00       	call   7c0 <free>
 ...
 1ec:	eb c3                	jmp    1b1 <thread_create+0x61>
...
thread_join()
{
 ...
 1f5:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
 1f8:	83 ec 1c             	sub    $0x1c,%esp
  int childPid = join(&stack);
 1fb:	50                   	push   %eax
 1fc:	e8 5a 03 00 00       	call   55b <join>
 ...
 204:	89 c6                	mov    %eax,%esi
  if(childPid != -1) {
 206:	83 f8 ff             	cmp    $0xffffffff,%eax
 209:	74 46                	je     251 <thread_join+0x61>
    for(int i=0; i < SIZE; i++) {
 20b:	31 db                	xor    %ebx,%ebx
 20d:	eb 09                	jmp    218 <thread_join+0x28>
 20f:	90                   	nop
 210:	83 c3 01             	add    $0x1,%ebx
 213:	83 fb 40             	cmp    $0x40,%ebx
 216:	74 39                	je     251 <thread_join+0x61>
      if(valueArray[i] == childPid) {
 218:	39 34 9d 80 0f 00 00 	cmp    %esi,0xf80(,%ebx,4)
 21f:	75 ef                	jne    210 <thread_join+0x20>
        free(userStackAddr[i]);
 221:	83 ec 0c             	sub    $0xc,%esp
 224:	ff 34 9d 80 10 00 00 	push   0x1080(,%ebx,4)
 22b:	e8 90 05 00 00       	call   7c0 <free>
        valueArray[i] = -1;
        userStackAddr[i] = NULL;
 230:	83 c4 10             	add    $0x10,%esp
        valueArray[i] = -1;
 233:	c7 04 9d 80 0f 00 00 	movl   $0xffffffff,0xf80(,%ebx,4)
 23a:	ff ff ff ff 
        userStackAddr[i] = NULL;
 23e:	c7 04 9d 80 10 00 00 	movl   $0x0,0x1080(,%ebx,4)
 245:	00 00 00 00 
    for(int i=0; i < SIZE; i++) {
 249:	83 c3 01             	add    $0x1,%ebx
 24c:	83 fb 40             	cmp    $0x40,%ebx
 24f:	75 c7                	jne    218 <thread_join+0x28>
      }
    }
  }
  return childPid;
...
free(void *ap)
{
 ...
 7c1:	a1 80 11 00 00       	mov    0x1180,%eax
{
 ...
 801:	5b                   	pop    %ebx
  freep = p;
 802:	89 15 80 11 00 00    	mov    %edx,0x1180
}
 808:	5e                   	pop    %esi
 809:	5f                   	pop    %edi
 80a:	5d                   	pop    %ebp
 ...
 839:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 83c:	89 15 80 11 00 00    	mov    %edx,0x1180
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 859:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 85c:	8b 3d 80 11 00 00    	mov    0x1180,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 89f:	73 4f                	jae    8f0 <malloc+0xa0>
    ...
    if(p == freep)
 8a1:	8b 3d 80 11 00 00    	mov    0x1180,%edi
 ...
 8ca:	e8 f1 fe ff ff       	call   7c0 <free>
  return freep;
 8cf:	8b 15 80 11 00 00    	mov    0x1180,%edx
 ...
 8fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 8ff:	89 15 80 11 00 00    	mov    %edx,0x1180
}
 ...
 90f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 910:	c7 05 80 11 00 00 84 	movl   $0x1184,0x1180
 917:	11 00 00 
    base.s.size = 0;
 91a:	bf 84 11 00 00       	mov    $0x1184,%edi
    base.s.ptr = freep = prevp = &base;
 91f:	c7 05 84 11 00 00 84 	movl   $0x1184,0x1184
 926:	11 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 929:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 92b:	c7 05 88 11 00 00 00 	movl   $0x0,0x1188
 932:	00 00 00 
    if(p->s.size >= nunits){
