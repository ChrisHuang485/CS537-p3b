...
lock_init(lock_t *lock)
{
  ...
  86:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
  8c:	5d                   	pop    %ebp
  8d:	c3                   	ret    
  8e:	66 90                	xchg   %ax,%ax
...
xchg(volatile uint *addr, uint newval)
{
  ...
  a2:	f0 87 02             	lock xchg %eax,(%edx)
  while (xchg(&(lock->locked), 1) != 0)
  a5:	85 c0                	test   %eax,%eax
  a7:	75 f7                	jne    a0 <lock_acquire+0x10>
  ;
}
  a9:	5d                   	pop    %ebp
  aa:	c3                   	ret    
...
thread_create(void (*start_routine)(void *, void *), void* arg1, void* arg2)
{
  ...
  c7:	68 00 20 00 00       	push   $0x2000
  cc:	e8 ef 06 00 00       	call   7c0 <malloc>
  if(freeStack == 0) return -1;
  d1:	83 c4 10             	add    $0x10,%esp
  d4:	85 c0                	test   %eax,%eax
  d6:	74 7f                	je     157 <thread_create+0x97>

  void *stack = freeStack;
  if((uint)freeStack % PGSIZE != 0)
  d8:	89 c2                	mov    %eax,%edx
  da:	89 c3                	mov    %eax,%ebx
  dc:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
  e2:	75 4c                	jne    130 <thread_create+0x70>
    stack = freeStack + PGSIZE -((uint)freeStack % PGSIZE);

  int childPid = clone(start_routine, arg1, arg2, stack);
  e4:	50                   	push   %eax
  e5:	ff 75 10             	push   0x10(%ebp)
  e8:	ff 75 0c             	push   0xc(%ebp)
  eb:	ff 75 08             	push   0x8(%ebp)
  ee:	e8 d0 03 00 00       	call   4c3 <clone>
  if(childPid != -1)
  f3:	83 c4 10             	add    $0x10,%esp
  f6:	83 f8 ff             	cmp    $0xffffffff,%eax
  f9:	74 45                	je     140 <thread_create+0x80>
  {
    for(int i = 0; i < SIZE; i++)
  fb:	31 d2                	xor    %edx,%edx
  fd:	eb 09                	jmp    108 <thread_create+0x48>
  ff:	90                   	nop
 100:	83 c2 01             	add    $0x1,%edx
 103:	83 fa 40             	cmp    $0x40,%edx
 106:	74 19                	je     121 <thread_create+0x61>
    {
      if(userStackAddr[i] == NULL)
 108:	8b 0c 95 c0 0d 00 00 	mov    0xdc0(,%edx,4),%ecx
 10f:	85 c9                	test   %ecx,%ecx
 111:	75 ed                	jne    100 <thread_create+0x40>
      {
        userStackAddr[i] = freeStack;
 113:	89 1c 95 c0 0d 00 00 	mov    %ebx,0xdc0(,%edx,4)
        valueArray[i] = childPid;
 11a:	89 04 95 c0 0c 00 00 	mov    %eax,0xcc0(,%edx,4)
  {
    free(freeStack);
  }
 ...
 132:	05 00 10 00 00       	add    $0x1000,%eax
 137:	eb ab                	jmp    e4 <thread_create+0x24>
 139:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    free(freeStack);
 140:	83 ec 0c             	sub    $0xc,%esp
 143:	89 45 f4             	mov    %eax,-0xc(%ebp)
 146:	53                   	push   %ebx
 147:	e8 e4 05 00 00       	call   730 <free>
 ...
 15c:	eb c3                	jmp    121 <thread_create+0x61>
 ...
 165:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
 168:	83 ec 1c             	sub    $0x1c,%esp
  int childPid = join(&stack);
 16b:	50                   	push   %eax
 16c:	e8 5a 03 00 00       	call   4cb <join>
 ...
 174:	89 c6                	mov    %eax,%esi
  if(childPid != -1) {
 176:	83 f8 ff             	cmp    $0xffffffff,%eax
 179:	74 46                	je     1c1 <thread_join+0x61>
    for(int i=0; i < SIZE; i++) {
 17b:	31 db                	xor    %ebx,%ebx
 17d:	eb 09                	jmp    188 <thread_join+0x28>
 17f:	90                   	nop
 180:	83 c3 01             	add    $0x1,%ebx
 183:	83 fb 40             	cmp    $0x40,%ebx
 186:	74 39                	je     1c1 <thread_join+0x61>
      if(valueArray[i] == childPid) {
 188:	39 34 9d c0 0c 00 00 	cmp    %esi,0xcc0(,%ebx,4)
 18f:	75 ef                	jne    180 <thread_join+0x20>
        free(userStackAddr[i]);
 191:	83 ec 0c             	sub    $0xc,%esp
 194:	ff 34 9d c0 0d 00 00 	push   0xdc0(,%ebx,4)
 19b:	e8 90 05 00 00       	call   730 <free>
        valueArray[i] = -1;
        userStackAddr[i] = NULL;
 1a0:	83 c4 10             	add    $0x10,%esp
        valueArray[i] = -1;
 1a3:	c7 04 9d c0 0c 00 00 	movl   $0xffffffff,0xcc0(,%ebx,4)
 1aa:	ff ff ff ff 
        userStackAddr[i] = NULL;
 1ae:	c7 04 9d c0 0d 00 00 	movl   $0x0,0xdc0(,%ebx,4)
 1b5:	00 00 00 00 
    for(int i=0; i < SIZE; i++) {
 1b9:	83 c3 01             	add    $0x1,%ebx
 1bc:	83 fb 40             	cmp    $0x40,%ebx
 1bf:	75 c7                	jne    188 <thread_join+0x28>
      }
    }
  }
  return childPid;
}
 1c1:	8d 65 f8             	lea    -0x8(%ebp),%esp
...
free(void *ap)
{
 ...
 731:	a1 c0 0e 00 00       	mov    0xec0,%eax
{
 ...
 771:	5b                   	pop    %ebx
  freep = p;
 772:	89 15 c0 0e 00 00    	mov    %edx,0xec0
}
 778:	5e                   	pop    %esi
 779:	5f                   	pop    %edi
 77a:	5d                   	pop    %ebp
 ...
 7a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 7ac:	89 15 c0 0e 00 00    	mov    %edx,0xec0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7cc:	8b 3d c0 0e 00 00    	mov    0xec0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 80f:	73 4f                	jae    860 <malloc+0xa0>
    ...
    if(p == freep)
 811:	8b 3d c0 0e 00 00    	mov    0xec0,%edi
 ...
 83a:	e8 f1 fe ff ff       	call   730 <free>
  return freep;
 83f:	8b 15 c0 0e 00 00    	mov    0xec0,%edx
 ...
 86c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 86f:	89 15 c0 0e 00 00    	mov    %edx,0xec0
}
